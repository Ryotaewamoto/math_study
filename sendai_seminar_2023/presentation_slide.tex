...
\begin{frame}{Spectrally defined matrix functions}
  \begin{block}{Definition 4}
    The function $\ExtendedRealValuedFunction{\Phi}{\NDemenstionalRealSymmetricMatrixSpace}$ is said to be spectrally defined if there exists a symmetric function $\ExtendedRealValuedFunction{f}{\NDemenstionalRealEuclidianSpace}$ such that
    \begin{equation}
